      ...
      {!eligible ? (
        ...
        <>
          ...
          <div className="grid gap-6 xl:grid-cols-[minmax(0,380px)_1fr]">
            {/* Month picker column */}
            <Card className="rounded-2xl border shadow-sm xl:h-fit">
              ...
              <CardContent className="space-y-5">
                {!isVesselManager && (
                  <div className="space-y-2">
                    <Label htmlFor="ais-vessel">Vessel</Label>
                    <Select
                    ...
                    <p className="text-xs text-muted-foreground">
                      Only vessels you are or were assigned to — same rules as editing your calendar.
                    </p>
                  </div>
                )}

                <div className="overflow-hidden rounded-2xl border bg-gradient-to-br from-sky-500/8 via-background to-blue-600/5">
                  <div className="flex items-center justify-between gap-2 border-b border-sky-500/10 px-3 py-2">
                    <Button
                      type="button"
                      variant="ghost"
                      size="icon"
                  ...
                  <div className="border-t border-sky-500/10 px-3 py-2">
                    <Input
                      ...
                      className="rounded-xl border-dashed bg-background/80"
                    />
                  </div>
                </div>
                ...
                <Collapsible open={customRangeOpen} onOpenChange={setCustomRangeOpen}>
                  <CollapsibleTrigger asChild>
                    <Button variant="ghost" size="sm" className="w-full rounded-lg text-muted-foreground">
                  ...
                  <CollapsibleContent className="space-y-3 pt-2">
                    <div className="flex items-center gap-3 rounded-lg border bg-muted/30 p-3">
                      ...
                      />
                      <Label htmlFor="custom-range" className="text-sm leading-snug">
                        Use custom range instead of full month (max {AIS_HISTORY_MAX_DAYS} days)
                      </Label>
                    </div>
                    {useCustomRange && (
                ...
                <div className="rounded-xl border border-dashed bg-muted/20 p-4">
                  <div className="flex gap-3">
                    ...
                    <div className="space-y-1 text-xs text-muted-foreground leading-relaxed">
                      ...
                      <p>
                        Each day uses the last AIS position recorded that day. Import adds an{' '}
                              ...
                              return (
                                ...
                                >
                                  ...
                                  <TableCell>
                                    ...
                                    <div className="space-y-0.5 text-xs text-muted-foreground md:hidden">
                                  ...
                                  <TableCell>
                                    <StatePill state={day.proposedState} />
                                  </TableCell>
