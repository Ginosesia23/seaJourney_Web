...
export default function CrewDocumentsPage() {
        ...
        try {
            ...
            const testimonialData = {
                testimonial: {
                    ...
                    notes: `Generated by vessel manager on ${format(new Date(), 'dd MMMM yyyy')}`,
    ...
    const handleSendToCaptain = async () => {
        ...
        try {
            ...
            const testimonialData = {
                ...
                official_body: null,
                official_reference: null,
                notes: `Generated by vessel manager on ${format(new Date(), 'dd MMMM yyyy')}. Awaiting captain approval.`,
    ...
    const handleGenerateNavWatchApplication = async (certificateType: MCACertificateType) => {
        ...
        try {
            ...
            const fromDateFormatted = format(startDate, 'dd/MM/yyyy');
            const toDateFormatted = format(endDate, 'dd/MM/yyyy');
            ...
            const dateOfBirth = (crewProfile as any).dateOfBirth || (crewProfile as any).date_of_birth
                ? format(parse((crewProfile as any).dateOfBirth || (crewProfile as any).date_of_birth, 'yyyy-MM-dd', new Date()), 'dd/MM/yyyy')
                : '';
                                    ...
                                    <Table>
                                        ...
                                        <TableBody>
                                            {selectedMemberData.testimonials.map((testimonial) => {
                                                const vessel = getVesselDetails(testimonial.vessel_id);
                                                const startDate = format(new Date(testimonial.start_date), 'MMM dd, yyyy');
                                                const endDate = format(new Date(testimonial.end_date), 'MMM dd, yyyy');
